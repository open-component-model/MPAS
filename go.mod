...
require (
	...
	github.com/fluxcd/helm-controller/api v0.34.1 // indirect
	github.com/fluxcd/image-automation-controller/api v0.34.1 // indirect
	github.com/fluxcd/image-reflector-controller/api v0.28.0 // indirect
